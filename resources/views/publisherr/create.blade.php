            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="overflow-x-auto">
                        ...
                        <form action="{{ route('publisherr.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="text" name="name"class="input input-bordered join-item" placeholder="nama perusahaan"/>
                            <input type="text" name="address"class="input input-bordered join-item" placeholder="alamat"/>
